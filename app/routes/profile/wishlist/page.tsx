      ...
      <div className="max-w-7xl mx-auto z-10 relative">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-6 border-b border-white/5 pb-10">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <h1 className="text-5xl font-black tracking-tighter text-white uppercase">Favorilerim</h1>
          ...
          {favorites.length > 0 && (
            <button 
              onClick={clearAll} 
              className="flex items-center gap-3 bg-gradient-to-r from-slate-800 via-blue-400 to-blue-700 hover:from-blue-700 hover:to-slate-800 px-8 py-4 rounded-[1.5rem] transition-all font-black text-white active:scale-95"
            >
        ...
        {favorites.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-40 text-center">
            <h2 className="text-white text-2xl font-black mb-8 tracking-widest italic opacity-50 uppercase">LİSTE ŞU AN BOŞ</h2>
            <Link href="/" className="bg-white text-black px-12 py-5 rounded-[1.5rem] font-black hover:bg-pink-500 hover:text-white transition-all shadow-2xl uppercase">
              KEŞFETMEYE BAŞLA
            </Link>
          </div>
        )}
