...
import { Edit2, Trash2, Power, BarChart3, Clock, MoreHorizontal } from 'lucide-react';
...
export const CampaignCard = ({ title, image, status, clicks, period }: CampaignProps) => (
  <div className="bg-slate-900/20 border border-slate-800/60 rounded-2xl overflow-hidden hover:border-indigo-500/40 transition-all duration-300 group">
    ...
    <div className="p-5 space-y-5">
      ...
      <div className="flex gap-2">
        <button className="flex-1 flex justify-center items-center py-2 bg-slate-800/40 hover:bg-indigo-500/10 rounded-xl text-slate-400 hover:text-indigo-400 transition-all border border-slate-800/60">
          <Edit2 size={14} />
        </button>
        <button className="flex-1 flex justify-center items-center py-2 bg-slate-800/40 hover:bg-emerald-500/10 rounded-xl text-slate-400 hover:text-emerald-500 transition-all border border-slate-800/60">
          <Power size={14} />
        </button>
        <button className="px-3 flex justify-center items-center py-2 bg-slate-800/40 hover:bg-rose-500/10 rounded-xl text-slate-400 hover:text-rose-500 transition-all border border-slate-800/60">
          <Trash2 size={14} />
        </button>
      </div>
    </div>
